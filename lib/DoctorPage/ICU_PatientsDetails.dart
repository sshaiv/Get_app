...
class ICUPatientList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<PatientData>>(
      // Replace with your actual method to fetch patient data
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'IPD No. ${patient.visitId}', // Adjust according to your data model
                                overflow: TextOverflow.ellipsis,
                                style: TextStyle(
                                  fontSize: 14,
                                  fontWeight: FontWeight.w500,
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    _buildFontAwesomeIconButton(
                                        context, FontAwesomeIcons.vial, Colors.blue, const InvestigationPage()),
                                    _buildFontAwesomeIconButton(
